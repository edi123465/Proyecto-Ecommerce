...
// Llamar al método para crear la cuenta
            ...
            if (isset($resultado)) {
// Mostrar la alerta y redirigir después
                echo "<script>
                        alert('" . $resultado . "');
...
<html lang="en">
    ...
    <!-- Mirrored from freshcart.codescandy.com/pages/shop-cart.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 12 Aug 2022 17:46:29 GMT -->
    <head>
                            ...
                            <ul class="navbar-nav ">
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li><a class="dropdown-item" href="shop-cart.php">Shop Cart</a></li>
                    ...
                    <div class="col-12">
                        ...
                        <div class="card py-1 border-0 mb-8">
                            <div>
                                ...
                                <p class="mb-0">Numero de pedido: 000100</p>
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <li class="list-group-item py-3 py-lg-0 px-0 border-top">
                                    ...
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-4 col-md-6">
                                            ...
                                            <span><small class="text-muted">.98 / lb</small></span>
                                            <!-- text -->
                                            <div class="mt-2 small "> <a href="#!" class="text-decoration-none text-inherit"> <span
