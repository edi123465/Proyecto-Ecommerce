document.addEventListener("DOMContentLoaded", function () {
    ...
    saveChangesButton.addEventListener("click", function () {
        ...
        if (confirmUpdate) {
            ...
            fetch('http://localhost:8088/Milogar/Controllers/UsuarioController.php?action=updateClient', {
                method: 'POST',
                headers: {
...
function cambiarContrasenia(event) {
    ...
    fetch("http://localhost:8088/Milogar/Controllers/UsuarioController.php?action=cambiarContrasenia", {
        method: "POST",
        headers: {
            "Content-Type": "application/json"
        },
...
document.getElementById("eliminarCuenta").addEventListener("click", function () {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            fetch("http://localhost:8088/Milogar/Controllers/UsuarioController.php?action=eliminarCuenta", {
                method: "POST",
                headers: {
                    "Content-Type": "application/json"
                },
