document.addEventListener("DOMContentLoaded", function () {
    ...
    function obtenerPedidosUsuario() {
        ...
        fetch(`http://localhost:8088/Milogar/Controllers/PedidosController.php?action=obtenerPedidosUsuario&userId=${userId}`)
            .then(response => {
...
function mostrarDetallesPedido(pedidoId) {
    ...
    fetch(`http://localhost:8088/Milogar/Controllers/PedidosController.php?action=obtenerDetallePedidosPorId&id=${pedidoId}`)
