...
function cargarCanjeables() {
    ...
    fetch('http://localhost:8088/Milogar/Controllers/CanjeController.php?action=obtenerCanjes')
        ...
        .then(data => {
            ...
            data.forEach(canje => {
                ...
                row.innerHTML = `
                    ...
                    <td>${canje.estado}</td>
                    <td><img src="http://localhost:8088/Milogar/assets/imagenesMilogar/productos/${canje.imagen}" alt="${canje.nombre}" style="width: 50px; height: 50px;"></td>
...
function editarCanjeable(id) {
    ...
    fetch(`http://localhost:8088/Milogar/Controllers/CanjeController.php?action=obtenerCanjeporId&id=${id}`)
        .then(response => response.json())
        .then(data => {
            ...
            document.getElementById('imagenPreviewEditar').src = `http://localhost:8088/Milogar/assets/imagenesMilogar/productos/${canje.imagen}`;
...
function cargarProductosEdit(selectedProductId) {
    ...
    fetch('http://localhost:8088/Milogar/Controllers/CanjeController.php?action=getProductos')
        .then(response => response.json())
        .then(data => {
...
function enviarCanjeable(event) {
    ...
    fetch('http://localhost:8088/Milogar/Controllers/CanjeController.php?action=crearCanjeable', {
        method: 'POST',
        body: formData
    })
...
document.getElementById('producto_id').addEventListener('change', function() {
    ...
    if (productoId) {
        ...
        fetch('http://localhost:8088/Milogar/Controllers/CanjeController.php?action=obtenerProductoDetalles&id=' + productoId)
            .then(response => response.json())
            .then(data => {
                console.log('Datos recibidos del servidor:', data);
                ...
                if (data && data.nombreProducto) {
                    ...
                    var imagenUrl = 'http://localhost:8088/Milogar/assets/imagenesMilogar/productos/' + data.imagen;
...
document.getElementById("formEditarCanjeable").addEventListener("submit", function (e) {
    ...
    fetch('http://localhost:8088/Milogar/Controllers/CanjeController.php?action=editarCanjeable', {
        method: 'POST',
        body: formData
    })
    .then(response => response.json())
...
function eliminarCanjeable(id) {
    ...
    fetch(`http://localhost:8088/Milogar/Controllers/CanjeController.php?action=eliminarCanjeable&id=${id}`, {
