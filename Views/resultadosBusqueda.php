...
// Recuperar los productos de la sesión con los resultados de la busqueda
$productosBusqueda = isset($_SESSION['productosBusqueda']) ? $_SESSION['productosBusqueda'] : [];
$errorBusqueda = isset($_SESSION['errorBusqueda']) ? $_SESSION['errorBusqueda'] : '';

// Limpiar la sesión después de usarla
unset($_SESSION['productosBusqueda']);
                ...
                <div class="col-lg-9 col-md-8">
                    ...
                    <div class="card mb-4 bg-light border-0">
                        ...
                        <div class=" card-body p-9">
                            <h1 class="mb-0">Buscando por Nombre, categoria o subcategoria</h1>
                        </div>
                    </div>
                    ...
                    <?php if (!empty($errorBusqueda)): ?>
                        <p class="alert alert-warning"><?= $errorBusqueda; ?></p>
                    <?php endif; ?>
                                    ...
                                    <div class="card card-product">
                                        <div class="card-body">
                                            ...
                                            <div class="text-small mb-1">
                                                <a href="#!" class="text-decoration-none text-muted"><small><?php echo htmlspecialchars($producto['nombreCategoria']); ?></small></a>
                                            </div>
                                            <h2 class="fs-6">
                                                <a href="#!" class="text-inherit text-decoration-none"><?php echo htmlspecialchars($producto['nombreProducto']); ?></a>
                                            </h2>

                                            <!-- Precio -->
                                            <div class="d-flex justify-content-between align-items-center mt-3">
                                                <div>
                                                    <span class="text-dark"><?php echo '$' . number_format($producto['precio_1'], 2); ?></span>
                                                ...
                                                <div>
                                                    <a href="#!" class="btn btn-primary btn-sm add-to-cart"
                                                        ...
                                                        data-nombre="<?php echo $producto['nombreProducto']; ?>"
                                                        data-precio="<?php echo number_format($producto['precio_1'], 2); ?>"
                                                        data-imagen="<?php echo htmlspecialchars($rutaImagen); ?>">
