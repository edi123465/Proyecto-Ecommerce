                ...
                <div class="sidebar">
                    ...
                    <nav class="mt-2">
                        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                            ...
                            <li class="nav-item">
                                <a href="RolesUsuarios/index.php" class="nav-link">
                            ...
                            <li class="nav-item">
                                <a href="Subcategorias/index.php" class="nav-link">
                                    <i class="nav-icon far fa-image"></i>
                                    <p>
                                        Subcategorías
                                    </p>
                            ...
                            <li class="nav-item">
                                <a href="../Views/PedidosTienda/index.php" class="nav-link">
                                    <i class="nav-icon far fa-image"></i>
                                    <p>
                                                ...
                                                <div class="direct-chat-messages">
                                                    ...
                                                    <div class="direct-chat-msg">
                                                        <div class="direct-chat-infos clearfix">
                                                            <span class="direct-chat-name float-left"><?php echo htmlspecialchars($_SESSION['user_name']); ?></span>
                                            ...
                                            <div class="card-body p-0">
                                                <ul class="users-list clearfix">
                                                    <li>
                                                        ...
                                                        <a class="users-list-name" href="#"><?php echo htmlspecialchars($_SESSION['user_name']); ?></a>
