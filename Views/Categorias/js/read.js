document.addEventListener("DOMContentLoaded", function () {
    ...
    function obtenerCategorias() {
        fetch('http://localhost:8088/Milogar/Controllers/CategoriaController.php?action=obtenerCategorias')
                ...
                if (data.status === 'success') {
                    ...
                    data.data.forEach(categoria => {
                        ...
                        const imagenUrl = categoria.imagen && categoria.imagen.startsWith('http')
                            ? categoria.imagen
                            : 'http://localhost:8088/Milogar/assets/imagenesMilogar/Categorias/' + (categoria.imagen || 'default.png');
...
function obtenerCategoriaId(id) {
    ...
    fetch(`http://localhost:8088/Milogar/Controllers/CategoriaController.php?action=obtenerCategoriaPorId&id=${id}`)
        ...
        .then(data => {
            ...
            if (data && data.status === 'success') {
                ...
                if (data.data.imagen) {
                    document.getElementById('imagenCategoriaPreview').src = `http://localhost:8088/Milogar/assets/imagenesMilogar/Categorias/${data.data.imagen}`;
                } else {
...
function guardarCambios() {
    ...
    fetch('http://localhost:8088/Milogar/Controllers/CategoriaController.php?action=editarCategoria', {
        method: 'POST',
        body: formData,
    })
...
function eliminarCategoria(id) {
    ...
    fetch('http://localhost:8088/Milogar/Controllers/CategoriaController.php?action=eliminarCategoria', {
        method: 'POST',
        body: formData,
    })
