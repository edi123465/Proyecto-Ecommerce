...
function cargarRoles() {
    return fetch('http://localhost:8088/Milogar/Controllers/RolController.php?action=getRoles')
...
function actualizarUsuario() {
    ...
    if (confirmacion) {
        ...
        fetch(`http://localhost:8088/Milogar/Controllers/UsuarioController.php?action=actualizarUsuario&id=${id}`, {
