...
@media (max-width: 576px) {
    .pagination-container {
        justify-content: center; /* Asegura que se centre en pantallas pequeñas */
    }
}
...
<body class="hold-transition dark-mode sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
   ...
   <!-- ¿El producto tiene tallas? -->
                                <div class="form-group">
                                    <label for="is_talla">¿El producto tiene tallas?</label>
                        ...
                        <div class="modal-body">
                            <form id="formEditarProducto" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <br>
                                    <img id="imagenPreview" src="https://milogar.wuaze.com/assets/imagenesMilogar/productos/default.png" alt="Imagen del                            Producto" width="100" />
                                </div>
