document.addEventListener('DOMContentLoaded', function () {
    ...
    function obtenerSubcategorias() {
        fetch('http://localhost:8088/Milogar/Controllers/SubcategoriaController.php?action=obtenerSubcategorias')
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function obtenerCategorias() {
        fetch('http://localhost:8088/Milogar/Controllers/SubcategoriaController.php?action=obtenerCategorias')
            .then(response => response.json())
            .then(result => {
                if (result.status === 'success') {
...
document.getElementById('submitCreateSubCategory').addEventListener('click', function (event) {
    ...
    fetch('http://localhost:8088/Milogar/Controllers/SubcategoriaController.php?action=insertarSubcategoria', {
        method: 'POST',
        headers: {
    ...
    fetch('http://localhost:8088/Milogar/Controllers/SubcategoriaController.php?action=obtenerCategorias')
        ...
        .then(data => {
            ...
            if (data.status === 'success') {
                ...
                fetch(`http://localhost:8088/Milogar/Controllers/SubcategoriaController.php?action=obtenerSubcategoriaId&id=${id}`)
                    .then(response => response.json())
                    .then(data => {
...
document.getElementById('submitEditSubCategory').addEventListener('click', function (event) {
    ...
    if (confirmEdit) {
        ...
        fetch('http://localhost:8088/Milogar/Controllers/SubcategoriaController.php?action=editarSubcategoria', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
...
function eliminarSubcategoria(id) {
    ...
    if (confirmDelete) {
        fetch('http://localhost:8088/Milogar/Controllers/SubcategoriaController.php?action=eliminarSubcategoria&id=' + id)
            .then(response => response.json())
            .then(data => {
                if (data.status === 'success') {
